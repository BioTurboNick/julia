...
eval(Core, :(LineInfoNode(mod::Module, @nospecialize(method), file::Symbol, line::Int, inlined_at::Int, specTypes::Any) =
             $(Expr(:new, :LineInfoNode, :mod, :method, :file, :line, :inlined_at, :specTypes))))
