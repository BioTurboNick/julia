...
int get_method_instance_root_reference(rle_reference *rr, jl_method_instance_t *m, size_t i) JL_NOTSAFEPOINT;
jl_value_t *lookup_root(jl_method_t *m, uint64_t key, int index) JL_NOTSAFEPOINT;
jl_value_t *lookup_method_instance_root(jl_method_instance_t *m, uint64_t key, int index) JL_NOTSAFEPOINT;
